...
// Elementos específicos do novo Dashboard (KPIs, gráficos, filtros e ranking)
// agora são resolvidos em js/dashboard.js, que é carregado por último.
...
// ==========================================================================
// O antigo "Painel de Andamento" (KPIs, filtros, gráfico e ranking) foi
// refatorado para o novo Dashboard e agora vive em:
//   js/filters.js   -> regras de filtro e status de execução das ações
//   js/charts.js    -> gráficos Chart.js (pizza, linha, setor, eixo)
//   js/dashboard.js -> orquestração, KPIs, ranking e navegação
// ==========================================================================
